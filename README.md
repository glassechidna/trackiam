...
* Unique services: 438
* Unique actions: 19901
* Managed policies: 1408
...
| `arn:aws:iam::aws:policy/aws-service-role/*` | 324 |
...
| [`cloudformation`](services/cloudformation.yml) | 82 | 0 | 19 |
...
| [`kafka`](services/kafka.yml) | 52 | 0 | 1 |
