...
| `arn:aws:iam::aws:policy/service-role/*` | 142 |
...
| [`comprehend`](services/comprehend.yml) | 67 | 4 | 0 |
...
| [`devops-guru`](services/devops-guru.yml) | 28 | 0 | 0 |
