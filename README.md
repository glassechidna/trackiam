...
* Unique services: 456
* Unique actions: 21259
* Managed policies: 1486
...
| `arn:aws:iam::aws:policy/Amazon*` | 367 |
| `arn:aws:iam::aws:policy/aws-service-role/*` | 339 |
...
| ------ | ----- | ----- | ----- |
| [`ec2`](services/ec2.yml) | 625 | 0 | 155 |
| [`sagemaker`](services/sagemaker.yml) | 351 | 0 | 78 |
| [`iot`](services/iot.yml) | 262 | 3 | 28 |
| [`chime`](services/chime.yml) | 259 | 0 | 57 |
| [`connect`](services/connect.yml) | 256 | 0 | 106 |
| [`glue`](services/glue.yml) | 214 | 4 | 88 |
...
| [`deadline`](services/deadline.yml) | 102 | 0 | 15 |
...
| [`elasticloadbalancing`](services/elasticloadbalancing.yml) | 66 | 0 | 11 |
...
| [`wisdom`](services/wisdom.yml) | 47 | 0 | 48 |
...
| [`ce`](services/ce.yml) | 41 | 0 | 18 |
| [`kinesisvideo`](services/kinesisvideo.yml) | 40 | 0 | 6 |
...
| [`cloudwatch`](services/cloudwatch.yml) | 38 | 0 | 25 |
...
| [`cases`](services/cases.yml) | 34 | 0 | 9 |
...
| [`access-analyzer`](services/access-analyzer.yml) | 33 | 2 | 4 |
| [`groundstation`](services/groundstation.yml) | 33 | 0 | 7 |
...
| [`kinesis`](services/kinesis.yml) | 32 | 0 | 8 |
...
| [`batch`](services/batch.yml) | 25 | 0 | 20 |
...
| [`verifiedpermissions`](services/verifiedpermissions.yml) | 24 | 2 | 7 |
| [`mediapackagev2`](services/mediapackagev2.yml) | 24 | 0 | 10 |
| [`fis`](services/fis.yml) | 24 | 0 | 5 |
| [`route53-recovery-control-config`](services/route53-recovery-control-config.yml) | 24 | 0 | 3 |
...
| [`emr-containers`](services/emr-containers.yml) | 23 | 0 | 2 |
...
| [`aws-marketplace`](services/aws-marketplace.yml) | 21 | 1 | 64 |
...
| [`identitystore`](services/identitystore.yml) | 19 | 0 | 8 |
| [`servicequotas`](services/servicequotas.yml) | 19 | 0 | 7 |
...
| [`healthlake`](services/healthlake.yml) | 13 | 0 | 36 |
...
| [`polly`](services/polly.yml) | 9 | 0 | 1 |
...
| [`bedrock-agentcore`](services/bedrock-agentcore.yml) | 0 | 0 | 207 |
...
| [`application-signals-mcp`](services/application-signals-mcp.yml) | 0 | 0 | 2 |
