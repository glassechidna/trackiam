...
| Policy ARN | Count |
| ------ | ----- |
| `arn:aws:iam::aws:policy/AWS*` | 334 |
| `arn:aws:iam::aws:policy/Amazon*` | 315 |
| `arn:aws:iam::aws:policy/aws-service-role/*` | 278 |
...
| [`quicksight`](services/quicksight.yml) | 174 | 3 | 30 |
...
| [`bedrock`](services/bedrock.yml) | 97 | 2 | 32 |
...
| [`wisdom`](services/wisdom.yml) | 47 | 0 | 14 |
...
| [`qapps`](services/qapps.yml) | 23 | 0 | 10 |
