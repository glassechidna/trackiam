...
* Unique services: 335
* Unique actions: 13864
* Managed policies: 1010
...
| `arn:aws:iam::aws:policy/aws-service-role/*` | 216 |
...
| [`backup`](services/backup.yml) | 66 | 0 | 8 |
...
| [`transcribe`](services/transcribe.yml) | 41 | 0 | 4 |
