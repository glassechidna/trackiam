...
| Policy ARN | Count |
| ------ | ----- |
| `arn:aws:iam::aws:policy/AWS*` | 365 |
| `arn:aws:iam::aws:policy/Amazon*` | 331 |
...
| [`cloudformation`](services/cloudformation.yml) | 82 | 0 | 12 |
...
| [`imagebuilder`](services/imagebuilder.yml) | 73 | 0 | 1 |
