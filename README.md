...
| Policy ARN | Count |
| ------ | ----- |
| `arn:aws:iam::aws:policy/AWS*` | 224 |
| `arn:aws:iam::aws:policy/Amazon*` | 207 |
| `arn:aws:iam::aws:policy/aws-service-role/*` | 146 |
...
| [`greengrass`](services/greengrass.yml) | 103 | 4 | 1 |
...
| [`iotevents`](services/iotevents.yml) | 20 | 0 | 14 |
