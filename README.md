...
* Unique services: 363
* Unique actions: 14783
* Managed policies: 1084
...
| `arn:aws:iam::aws:policy/Amazon*` | 279 |
...
| [`connect`](services/connect.yml) | 186 | 0 | 9 |
...
| [`wafv2`](services/wafv2.yml) | 48 | 3 | 2 |
...
| [`inspector2`](services/inspector2.yml) | 32 | 0 | 6 |
