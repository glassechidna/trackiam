...
* Managed policies: 1222

Most common managed policy name prefixes:

| Policy ARN | Count |
| ------ | ----- |
| `arn:aws:iam::aws:policy/AWS*` | 333 |
| `arn:aws:iam::aws:policy/Amazon*` | 313 |
| `arn:aws:iam::aws:policy/aws-service-role/*` | 276 |
...
| ------ | ----- | ----- | ----- |
| [`ec2`](services/ec2.yml) | 622 | 3 | 16 |
| [`sagemaker`](services/sagemaker.yml) | 351 | 0 | 15 |
| [`iot`](services/iot.yml) | 262 | 3 | 9 |
| [`chime`](services/chime.yml) | 259 | 0 | 50 |
| [`connect`](services/connect.yml) | 253 | 3 | 7 |
| [`glue`](services/glue.yml) | 214 | 4 | 44 |
| [`ses`](services/ses.yml) | 193 | 0 | 0 |
| [`quicksight`](services/quicksight.yml) | 174 | 3 | 29 |
...
| [`bedrock`](services/bedrock.yml) | 97 | 2 | 20 |
...
| [`workmail`](services/workmail.yml) | 84 | 0 | 34 |
...
| [`codepipeline`](services/codepipeline.yml) | 40 | 3 | 0 |
...
| [`qapps`](services/qapps.yml) | 23 | 0 | 9 |
...
| [`resource-explorer-2`](services/resource-explorer-2.yml) | 21 | 0 | 3 |
