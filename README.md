...
* Unique services: 358
* Unique actions: 14712
* Managed policies: 1056
...
| `arn:aws:iam::aws:policy/Amazon*` | 272 |
| `arn:aws:iam::aws:policy/aws-service-role/*` | 233 |
...
| [`sagemaker`](services/sagemaker.yml) | 315 | 2 | 11 |
